...
def layer_stats(
    ...
    def get_ds():
        ...
        arrow_files = sorted(glob.glob(
            "/root/autodl-fs/huggingface/datasets/wikimedia___wikipedia/20231101.en/0.0.0/b04c8d1ceb2f5cd4588862100d08de323dccfbaa/wikipedia-train-*.arrow"
        ))
        ...
        # 合并所有分片
        raw_ds = concatenate_datasets(datasets_list)

        # 包装成 DatasetDict
        raw_ds = DatasetDict({'train': raw_ds})
